    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                    ...
                    <?= $form->field($model, 'article_category')->dropDownList([NULL => ''] + ArrayHelper::map(common\models\ArticleCategory::find()->all(), 'id', 'name'))->label('Категория статьи ' . Html::a(' Создать ', '/article-category/create', ['class' => 'btn btn-primary'])) ?>
